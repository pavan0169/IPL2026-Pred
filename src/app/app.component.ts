...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, LayoutModule, PredictComponent, StandingsComponent, LockedPredictionsComponent, AdminComponent, LandingComponent, LeagueListComponent, UserProfileComponent, PastPredictionsComponent],
